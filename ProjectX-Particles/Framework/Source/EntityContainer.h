...
typedef bool(*PredicateFunction)(const Entity* entity);
typedef void(*OperationFunction)(Entity* entity1, Entity* entity2);
...
void EntityContainerApplyGravity(EntityContainer* entities);

void EntityContainerApplyPairOperation(EntityContainer* entities, PredicateFunction predicate, OperationFunction operation);
