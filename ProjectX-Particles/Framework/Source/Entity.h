...
#define EntityHas(entity, type) (type*)EntityGet(entity, c##type)
...
// (NOTE: This function must also set the component's parent pointer
//	  by calling the ComponentSetParent() function.)
// Params:
//	 entity = Pointer to the Entity.
//   component = Pointer to the component to be attached.
void EntityAdd(Entity* entity, Component* component);

Component* EntityGet(const Entity* entity, ComponentType type);
