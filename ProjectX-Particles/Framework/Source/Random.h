...
// Generate a random floating-point number in the interval [rangeMin, rangeMax] (inclusive).
// Params:
//	 rangeBase = The baseline value for a random range.
//	 rangeVar = The variation value for a random range (e.g. +/- rangeVar).
float RandomRangeBaseVar(float rangeBase, float rangeVar);
